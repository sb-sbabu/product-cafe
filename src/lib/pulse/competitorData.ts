...
export const TIER_1_COMPETITORS: CompetitorProfile[] = [
    ...
    // Additional RCM/Eligibility Competitors
    {
        id: 'availity',
        name: 'Availity',
        tier: 1,
        category: 'Eligibility',
        description: 'Real-time health information network connecting payers and providers. Eligibility & benefits.',
    ...
    },
    {
        ...
        tier: 1,
        category: 'Eligibility',
        description: 'AI-powered eligibility verification and prior authorization platform.',
        website: 'rhyme.com',
        founded: 2018,
        hq: 'San Francisco, CA',
        employees: '100+',
    ...
    },
    {
        ...
        tier: 1,
        category: 'Prior Auth',
        description: 'Intelligent automation for prior authorization workflows.',
        website: 'myndshft.com',
        founded: 2016,
        hq: 'Phoenix, AZ',
        employees: '50+',
        signalCount: 0,
    ...
    {
        id: 'jopari',
        name: 'Jopari Solutions',
        tier: 1,
        category: 'Eligibility',
        description: 'Workers compensation and auto medical eligibility verification.',
        website: 'jopari.com',
        founded: 2002,
        hq: 'El Segundo, CA',
        employees: '100+',
    ...
    },
    {
        ...
        tier: 1,
        category: 'Eligibility',
        description: 'Real-time insurance verification and patient estimation platform.',
        website: 'pverify.com',
        founded: 2010,
        hq: 'San Jose, CA',
        employees: '100+',
...
// ─────────────────────────────────────────────────────────────────────────────
// BPOs: Healthcare Outsourcing with AI/Automation (Strategic watch)
// ─────────────────────────────────────────────────────────────────────────────

export const BPO_COMPETITORS: CompetitorProfile[] = [
    {
        id: 'access-healthcare',
        name: 'Access Healthcare',
        tier: 1,
        category: 'RCM',
        description: 'Healthcare RCM BPO with AI automation. Serves hospitals and health systems.',
        website: 'accesshealthcare.com',
        founded: 2011,
        hq: 'Dallas, TX',
        employees: '20,000+',
        signalCount: 0,
    ...
    {
        id: 'ssi-group',
        name: 'SSI Group (ClaimRemedi)',
        tier: 1,
        category: 'RCM',
        description: 'RCM and claims management for hospitals. ClaimRemedi denials platform.',
    ...
    },
    {
        ...
        tier: 1,
        category: 'RCM',
        description: 'End-to-end RCM outsourcing with AI/ML automation capabilities.',
        website: 'omegahms.com',
        founded: 2003,
        hq: 'Bangalore, India',
        employees: '25,000+',
        signalCount: 0,
    ...
    },
    {
        ...
        tier: 1,
        category: 'RCM',
        description: 'RCM and HIM outsourcing with AI-powered coding and denials management.',
        website: 'gebbs.com',
        founded: 2005,
        hq: 'Pune, India',
        employees: '10,000+',
    ...
    },
    {
        ...
        tier: 2,
        category: 'RCM',
        description: 'Healthcare BPO including medical billing, coding, and RCM services.',
    ...
    },
    {
        ...
        tier: 2,
        category: 'RCM',
        description: 'Technology-enabled RCM services with AI automation focus.',
    ...
    {
        id: 'cognizant-hcs',
        name: 'Cognizant Healthcare',
        tier: 2,
        category: 'RCM',
        description: 'Cognizant healthcare BPO including TriZetto and RCM services.',
        website: 'cognizant.com/healthcare',
        founded: 1994,
        hq: 'Teaneck, NJ',
        employees: '50,000+',
        signalCount: 0,
